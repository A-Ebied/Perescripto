  ...
  return (
    <div className="flex items-center justify-between py-4 mb-5 border-b border-b-gray-400">
      ...
      <div className="flex items-center gap-4">
        ...
        <img onClick={() => setShowMenu(true)} className="w-6 cursor-pointer md:hidden" src={assets.menu_icon} alt="menu_icon" />
        {/* --------------------------------- Mobile Menu ------------------------ */}
        <div className={` ${showMenu ? 'fixed w-full ' :'h-0 w-0'} md:hidden right-0 top-0 bottom-0 z-20 overflow-hidden bg-white transition-all`}>
         <div className="flex items-center justify-between px-5 py-6">
         <img className="w-36 cursor-pointer" src={assets.logo} alt="logo" />
        <img
            onClick={() => setShowMenu(false)} className="w-6 cursor-pointer md:hidden"
